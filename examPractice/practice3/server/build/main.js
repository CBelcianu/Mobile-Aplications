...
function middleware(ctx, next) {
  ...
  return next().then(function () {
    ...
    console.log("".concat(start.toLocaleTimeString(), " ").concat(ctx.request.method, " ").concat(ctx.request.url, " - ").concat(ms, "ms"));
  });
}
...
module.exports = __webpack_require__(/*! C:\Work\facultate\an3\sem1\Mobile-Applications\examPractice\practice3\server\src/index.js */"./src/index.js");
